 ...
 * Description: SKT Addons for Elementor page builder is one of the great Elementor Addons that includes 92 absolutely free Elementor Widgets. These provide you more options to easily add more features and functionality into your existing website.
 * Version: 1.6
 * Author: SKT Themes
...
Copyright 2023 SKT Themes <https://www.sktthemes.org>
*/

defined('ABSPATH') || die();

define('SKT_ADDONS_ELEMENTOR_VERSION', '1.6');
...
define('SKT_ADDONS_ELEMENTOR_MINIMUM_ELEMENTOR_VERSION', '2.9.0');
define('SKT_ADDONS_ELEMENTOR_MINIMUM_PHP_VERSION', '5.4');
